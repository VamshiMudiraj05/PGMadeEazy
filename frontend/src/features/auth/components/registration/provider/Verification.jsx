  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-[#1E1E26] pb-4">
        <h3 className="text-xl font-bold text-white tracking-tight">Owner Identity & Verification</h3>
        <p className="text-xs text-[#7A7A85] mt-1">Required for host onboarding and compliance verification.</p>
      </div>
      ...
      <div className="p-4 rounded-sm bg-[#0B0B0E] border border-[#1E1E26]">
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <span className="text-xs text-[#9E9EA7] leading-relaxed">
            ...
            <span className="text-white font-semibold underline underline-offset-2">Host Terms & Conditions</span> and{" "}
            <span className="text-white font-semibold underline underline-offset-2">Compliance Policy</span>.
          </span>
        </label>
        {errors.termsAgreed && (
